...
namespace Photon.Pun.UtilityScripts
{
	...
	public class PunTurnManager : MonoBehaviourPunCallbacks, IOnEventCallback
    {
        ...
        public int Turn
        {
            ...
            private set
            {
                ...
                PhotonNetwork.CurrentRoom.SetTurn(value, false);
            }
        }
        ...
        /// </summary>
        /// <value>The remaining seconds fo the current turn</value>
        public float RemainingSecondsInGame
        {
            get { return Mathf.Max(0f, this.TurnDuration - this.ElapsedTimeInTurn); }
        }
    ...
    public static class TurnExtensions
    {
        ...
        /// <summary>
        /// start (server) time for first turn (used to calculate end)
        /// </summary>
        public static readonly string TurnFirstStartPropKey = "TStartFirst";
        ...
        public static void SetTurnTimer(this Room room)
        {
            if (room == null || room.CustomProperties == null)
            {
                return;
